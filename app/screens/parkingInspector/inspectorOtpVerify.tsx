  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (result.status === "success" && result.verified) {
        console.log("✅ OTP verified successfully for inspector!");

        // Show success message
        Alert.alert(
          "Success!",
          `Welcome ${params.inspectorName}! You have successfully logged in.`,
          [
            {
              text: "Continue",
              onPress: () => {
                ...
                router.replace({
                  pathname: "/screens/parkingInspector/inspectorDash",
                  params: {
                    inspectorId: params.inspectorId,
                    inspectorName: params.inspectorName,
                    employeeId: params.employeeId,
                    mobileNumber: params.mobileNumber,
                    inspectorStatus: params.inspectorStatus,
                  },
                });
              },
            },
...
export default InspectorOtpVerify;
